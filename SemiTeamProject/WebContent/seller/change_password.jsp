...
<script>
    ...
    function checkPw2() {
        ...
        var pw2 = document.querySelector("input[name=seller_pw]").value;
        
        var isValid = regex.test(pw2);
        
        var pw2Tag = document.querySelector("input[name=seller_pw]");
    ...
    function checkPw3() {
        ...
        if(document.querySelector("input[name=seller_pw]").value!=''&&
...
<article class="w-30">
	...
	<form action="seller_change_password.do" method ="post" onsubmit="return checkForm();">
		<div class="row">
		<table class="table table-sideopen">
			<tbody>
				...
				<tr>
					...
					<td class="left">
					    <div>
						<input class="intext" name="seller_pw" id="pwCheck" type="password" onblur="checkPw2();" placeholder="새 비밀번호">
