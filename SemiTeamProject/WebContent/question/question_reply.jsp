...
<form action="question_reply.do" method="post" onsubmit="return formCheck();">
	...
	<form action="question_reply.do" method="post">
		...
		<div class="row center">
			...
			<textarea  name="que_reply" rows="5px" cols="100px"><%if ( qvdto.getQue_reply() != null ) {%><%= qvdto.getQue_reply() %><%} %></textarea>
		</div>
		
		<div class="row right">
			<a href = "question_content.jsp?que_pension_no=<%= que_pension_no %>&que_no=<%= que_no %>">
				<input class="form-btn3" type="button" value="취소">
			</a>
			<input class="form-btn2" type="submit" value="등록">
		</div>
