      ...
      <table class="table table-sideopen left" style=border-collapse:inherit;>
         <tbody>
            ...
            <tr>
               ...
               <td class="tdstyle" rowspan="3">
                  <a href="room_list2.jsp?pension_no=<%=pdto.getPension_no()%>"><button type ="button" class='form-btn2 form-inline'>객실보기</button></a>
                  <a href="reservation_step1.do?pension_no=<%=pdto.getPension_no()%>&member_no=<%=member_no%>"><button class='form-btn2 form-inline'>예약하기</button></a>
